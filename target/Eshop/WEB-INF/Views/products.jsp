    		  ...
    		  $.ajax({
    			  ...
    			  success: function(result){
    				...
    				+"<img class=\"img-responsive\" src=\"resources/images/pdtImg.jpg\">"
    				  ...
    				  +"<div class=\"col-md-12\" style=\"text-align:centre;\"><button type=\"button\" class=\"btn btn-primary\">Add to Cart</button><button type=\"button\" class=\"btn btn-warning\">Buy Now</button></div>"
    				  +"</div></div>";
...
<div class="singlePdtWrap container" style="display:none;">
